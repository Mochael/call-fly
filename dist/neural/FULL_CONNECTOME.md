...
Graph preparation and recurrence are adapted from FLM, copyright 2026 Alex Wormuth, **MIT**; see [the preserved license](./FLM_LICENSE.txt). The earlier Fly Typist locomotor visualization remains available only in the legacy voice app, under its separate attribution.
